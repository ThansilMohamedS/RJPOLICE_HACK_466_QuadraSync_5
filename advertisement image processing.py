...
pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files\Tesseract-OCR'  # Change the path accordingly
...
def is_text_present_in_search(image_path):
    ...
    # Check if the extracted text is present in the top 4 search results
